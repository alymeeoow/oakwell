        ...
        <div className="footer-main-oak">
          ...
          <div className="footer-links-oak">
            ...
            <div className="footer-column-oak">
              ...
              <Link to="/biosecurity-testing" className="footer-link-oak">
                Biosecurity Testing
              </Link>
              <Link to="/lab-supplies" className="footer-link-oak">
                Lab Supplies
              </Link>
              <Link to="/feed-nutrition" className="footer-link-oak">
                Feed & Nutrition
              </Link>
            ...
            <div className="footer-column-oak">
              ...
              <a href="mailto:info@oakwelldistribution.com" className="footer-link-oak contact-link">
                info@oakwelldistribution.com
              </a>
              <a href="tel:+15551234567" className="footer-link-oak contact-link">
                +1 (555) 123-4567
              </a>
              <span className="footer-link-oak contact-text">
                Nationwide Shipping
              </span>
            </div>
          </div>
